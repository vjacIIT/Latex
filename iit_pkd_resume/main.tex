...
\SimpleEntry{\large Algorithms enthusiastic. Wanted to pursue my carrer in the field of algorithms  }
...
\WorkExp{Sofware Intern at Rupeek Fintech Private Limited}
{May 2019 to June 2019}
{Have done my internship at Rupeek fintech}
{https://www.codechef.com/users/vjac} 

\NewPart{Conference Proceddings}
\WorkExp{Type name of conference here}
{Year here}
{This is the description of my conference}
{https://google.com}


\NewPart{Recent Publications}
\RecentPublication{Journal Name}
{Publisher here}
{Mentor here}
